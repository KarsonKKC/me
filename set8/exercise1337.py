...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    """
    fire_emoji = list(f"{input_string}".upper())
    fire_emoji = "🔥".join(fire_emoji)
    return "🔥" + fire_emoji + "🔥"
...
def best_letter_for_pets() -> str:
    ...
    most_popular_letter = "🤷‍♀️🤷‍♀️🤷‍♀️🤷‍♀️🤷‍♀️🤷‍♀️🤷‍♀️🤦‍♂️🤦‍♂️🤦‍♂️🤦‍♂️🤦‍♂️🤦‍♂️🤦‍♂️🤦‍♂️"
    longest_petname = 0
